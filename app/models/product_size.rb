...
@bust_range_extra_large_end = (@extra_large_product_size.bust_measurement + 20) *2
...
@waist_range_extra_large_end = (@extra_large_product_size.waist_measurement + 20) *2
end
...
@length_range_extra_large_end = (@extra_large_product_size.length_measurement + 20) *2
end
