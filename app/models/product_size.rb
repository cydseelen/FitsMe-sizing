class ProductSize < ApplicationRecord
  ...
  def convert_product_size_data
    ...
    if size_name == "extra small"
      self.hip_range = @hip_range_extra_small_start...@hip_range_extra_small_end
      self.bust_range = @bust_range_extra_small_start...@bust_range_extra_small_end
      self.waist_range = @waist_range_extra_small_start...@waist_range_extra_small_end
      self.length_measurement = @length_range_extra_small_start...@length_range_extra_small_end
      self.save
    raise
    elsif size_name == "small"
      self.hip_range = @hip_range_small_start...@hip_range_small_end
      self.bust_range = @bust_range_small_start...@bust_range_small_end
      self.waist_range = @waist_range_small_start...@waist_range_small_end
      self.length_measurement = @length_range_small_start...@length_range_small_end
      self.save
    elsif size_name == "medium"
      self.hip_range = @hip_range_medium_start...@hip_range_medium_end
      self.bust_range = @bust_range_medium_start...@bust_range_medium_end
      self.waist_range = @waist_range_medium_start...@waist_range_medium_end
      self.length_measurement = @length_range_medium_start...@length_range_medium_end
      self.save
    elsif size_name == "large"
      self.hip_range = @hip_range_large_start...@hip_range_large_end
      self.bust_range = @bust_range_large_start...@bust_range_large_end
      self.waist_range = @waist_range_large_start...@waist_range_large_end
      self.length_measurement = @length_range_large_start...@length_range_large_end
      self.save
    elsif size_name == "extra large"
      self.hip_range = @hip_range_extra_large_start...@hip_range_extra_large_end
      self.bust_range = @bust_range_extra_large_start...@bust_range_extra_large_end
      self.waist_range = @waist_range_extra_large_start...@waist_range_extra_large_end
      self.length_measurement = @length_range_extra_large_start...@length_extra_range_large_end
      self.save
    end
...
@bust_range_medium_end = (@arge_product_size.bust_measurement - ((@large_product_size.bust_measurement - @medium_product_size.bust_measurement) / 2))*2,
